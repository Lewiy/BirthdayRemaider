...
public class DaysYearsSignAdapter {
    ...
    public static String adapterSignLeftYears(Context context, int countYears) {
        ...
        switch (countYears) {
            case 0:
                return context.getResources().getString(R.string.will_be);
            case 1:
                return god(context, countYears);
            case 21:
                return god(context, countYears);
            case 31:
                return god(context, countYears);
            ...
            case 2:
                return goda(context, countYears);
            case 3:
                return goda(context, countYears);
            case 4:
                return goda(context, countYears);
